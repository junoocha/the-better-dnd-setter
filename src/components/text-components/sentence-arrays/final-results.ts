export const lowStr = [
	...
	`Asked to push a boulder and responded with a thoughtful sigh and a snack break.`,
	`Once lifted a chair with so much effort that even the chair felt bad about it.`,
	`Swung a sword with the power of a gentle suggestion.`,
	`Tried to help carry supplies and ended up supervising instead.`,
	`Biceps resemble well-fed noodles on a breezy day.`,
	`Managed to bend a spoon slightly... after several intense minutes.`,
	`The arm-wrestling competition ended with enthusiastic clapping for trying.`,
	`Called for backup to open a slightly stuck drawer.`,
	`Carries weapons like they're borrowed from someone much stronger.`,
	`Lifted a training dummy and immediately apologized to it.`,
	`Pushed on a stuck door and it pushed back emotionally.`,
	`Referred to as a "combat encourager" more than a combatant.`,
	`Swings a mace like it's filled with regret instead of metal.`,
	`The training weights have started gathering dust out of pity.`,
	`Struggled with a backpack and declared it cursed.`,
];
...
export const lowInt = [
	...
	`Asked the oracle a question and forgot what it was halfway through.`,
	`Once mistook a puzzle box for a snack container and got frustrated when it wouldn't open.`,
	`Thinks philosophy is mostly just agreeing with the loudest person in the room.`,
	`Spent an hour debating with a parrot who wasn't even talking back.`,
	`Tried to learn a spell by yelling the words louder each time it failed.`,
	`Once studied a map upside down and insisted the mountains had moved.`,
	`Came to a profound conclusion, but forgot it immediately after blinking.`,
	`Reads ancient texts like bedtime stories, complete with dramatic gasps.`,
	`Wears a thinking cap that mostly just makes everything itchier.`,
	`Confused a magical artifact for a fancy soup bowl and used it accordingly.`,
	`Has an impressive collection of half-finished ideas and misunderstood proverbs.`,
	`Once asked a ghost if it had read any good books lately.`,
	`Tried to explain a plan but got distracted halfway through describing snacks.`,
	`Insists that common sense is overrated and suspiciously hard to find.`,
	`Believes logic is best when it involves a little guesswork and a lot of hope.`,
];
...
export const lowDex = [
	...
	`Slipped while standing still and blamed the floor for being shifty.`,
	`Dropped a dagger during a duel and spent the rest of the fight apologizing.`,
	`Once tried to vault a fence and gently introduced their face to the dirt.`,
	`Moves like an idea half-formed and poorly communicated to the legs.`,
	`Jumps with the grace of a startled turnip.`,
	`Steps quietly only when accidentally walking on flowers.`,
	`Has turned tripping into a high art that bards quietly admire.`,
	`Once attempted stealth by holding their breath and loudly tiptoeing.`,
	`Ropes, ladders, and stairs each have a personal vendetta.`,
	`Balanced on a log once and immediately fell like a poetic metaphor.`,
	`Creaks louder than the haunted door they're trying to sneak past.`,
	`Considered climbing, then wisely decided falling was faster.`,
	`Gets tangled in their own cloak more often than enemies' traps.`,
	`Sneak attacks are often preceded by a sneeze and a clank.`,
	`Approaches acrobatics like a confused golem in roller boots.`,
];
...
export const lowCon = [
	...
	`Coughed once and needed a three-day nap to recover.`,
	`Thinks allergies are a seasonal curse from a vengeful druid.`,
	`Once pulled a muscle trying to put on armor too enthusiastically.`,
	`Faints slightly when standing up too quickly.`,
	`Heals just in time to get sick from the effort of healing.`,
	`Treats mild weather like a personal affront from the elements.`,
	`Adventures with the endurance of warm pudding on a hot day.`,
	`Armor gives rashes, potions cause hiccups, bandages unravel.`,
	`Requires a break after walking briskly or thinking about it.`,
	`Carries more remedies than weapons... and uses them more often.`,
	`Gets winded from heroic monologues, not battles.`,
	`Knows the local healer's name, birthday, and favorite tea.`,
	`Recovers from scratches like they've fought a dragon.`,
	`Wears a helmet mostly to cushion frequent fainting spells.`,
	`Known for heroic wheezing after minor efforts.`,
];
...
export const lowWis = [
	...
	`Often forgets which mushrooms are edible but eats them anyway.`,
	`Once followed a trail of breadcrumbs into someone else's picnic.`,
	`Trusted a talking squirrel with directions and ended up lost for days.`,
	`Has profound visions regularly... all caused by mild dehydration.`,
	`Finds omens in clouds, puddles, and misplaced laundry.`,
	`Always senses danger... about twenty minutes too late.`,
	`Believes every sign is a metaphor, even the ones that just say "No".`,
	`Confuses superstition for wisdom and is very committed to both.`,
	`Known to give advice that sounds deep but is just wrong.`,
	`Listens to the wind for guidance and often mishears it sneezing.`,
	`Takes life lessons from overheard tavern arguments.`,
	`Meditated under a tree and forgot to leave for three days.`,
	`Follows intuition wherever it meanders... which is usually off a cliff.`,
	`Often sees patterns where there are only breadcrumbs and regrets.`,
	`Would consult the stars, but thinks they hold grudges.`,
];
...
export const lowCha = [
	...
	`Once tried to break the ice and instead froze the entire room.`,
	`Compliments land like confused birds with no sense of direction.`,
	`Tells jokes that start strong and end in mutual discomfort.`,
	`Has a voice that makes even enchanted mirrors look away awkwardly.`,
	`Flirting technique involves nervous laughter and vague gestures.`,
	`Social cues are interpreted with the precision of a sleepy troll.`,
	`Once gave a rousing speech that accidentally offended everyone present.`,
	`Introduces themselves with flair and then forgets the rest of the sentence.`,
	`Known for expressions that make friends unsure if it's a joke or a cry for help.`,
	`Negotiations often end with someone handing over a snack out of pity.`,
	`Believes winking is charming, but it mostly looks like they're in pain.`,
	`Accidentally started a bar fight while trying to order soup.`,
	`Tried to inspire courage but only managed mild embarrassment.`,
	`Spells of persuasion tend to fizzle out in a puff of awkward silence.`,
	`Managed to befriend a dog once, but even it needed time to warm up.`,
];
