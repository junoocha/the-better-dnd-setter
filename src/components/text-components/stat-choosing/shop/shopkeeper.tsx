...
export default function ShopStats({ onComplete, pointLimit }: ShopStatsProps) {
	...
	// just how the cost is calculated, go down or up
	...
	// determines value by going up or down, as well as calculating points
			...
			<div className="flex flex-col items-center justify-center gap-2  sm:p-6 md:p-8 ">
				...
				<div className="flex justify-between w-full px-4 mb-4 sm:hidden">
					...
					<motion.div
						...
						className="bg-black border-4 border-white rounded-md px-2 py-2 shadow-md text-white font-bold space-y-2 flex-1 mr-2"
					>
					...
					<motion.div
						...
						animate={{ opacity: 1, y: 0 }}
						transition={{ duration: 1, delay: 5.5 }}
						className="bg-black border-4 border-white rounded-md px-1 py-1 shadow-md text-white font-bold space-y-2 flex-1 ml-2"
					>
				...
				{/* desktop signs: hide signs on mobile */}
