...
// coordinates for primary stats, including positive and negative placements
...
// coordinates for each skill and its associated stat modifier
...
export async function generatePDFBytes(assignments: Record<string, number>) {
	// grab oriignal pdf from public and load it as byte array
	...
	// grab bytes from file using file path we just made
